...
export class AppServiceService {
  ...
  createMarca(nom:string,desc:string){
    return this.http.post<MrcFncnInterface>(`${this.baseUrl}/marca/create`,new AddMarca(nom,desc,1))
  }
  updateMarca(id:number,nom:string,desc:string){
    return this.http.put<MrcFncnInterface>(`${this.baseUrl}/marca/update/${id}`,new AddMarca(nom,desc,1))
  }
